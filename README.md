...
SunChain — Decentralized Solar Energy Network on Sui

Title Slide:

Project: SunChain
Tagline: Powering a Connected Africa through Decentralized Energy Infrastructure
Built on: Sui Blockchain
By: Isarck Eser (Team SunChain)
...
A DePIN (Decentralized Physical Infrastructure Network) connecting community solar hubs using Sui.
Each hub records energy data on-chain for transparency & trust.
Users pay via Sui smart contracts using stablecoins.
...
2. Data is sent to Sui and stored on-chain.
...
- Hardware expansion (solar IoT units)

- Smart contract audits

- Dashboard & mobile app improvements
...
- Isarck Eser @SirIsarck001 (Founder) — Web3 Builder, DePIN Innovator. Blockchain learner focusing on decentralized infrastructure. Interested in DePIN models for energy and connectivity.

- Kabir Muhammad @Ishaqkdw (CFO)
...
Q4 2025: Launch IoT-enabled pilot on Sui
...
To make clean energy as open and borderless as the internet itself, powered by Sui.
